...
int main(){
   ...
   /// C
   bool seVendieronBlancas = false, seVendieronNegras = false, seVendieronMarrones = false, seVendieronGrises = false; //banderas
   ...
   cout << "C) Colores de carteras que no se vendieron (con banderas): " << endl; // en este punto usamos bandera
